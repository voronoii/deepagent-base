    ...
    <aside className="w-64 border-r border-slate-200 bg-white flex-col hidden lg:flex">
      <div className="p-6">
        <div className="flex items-center gap-3 text-primary mb-8">
          ...
          <h1 className="text-lg font-bold leading-tight tracking-tight text-slate-900">DeepAgent</h1>
        </div>
      ...
      <div className="mt-auto p-4 border-t border-slate-200">
        <div className="bg-slate-50 p-4 rounded-xl">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-semibold text-slate-500">CONTEXT MEMORY</span>
